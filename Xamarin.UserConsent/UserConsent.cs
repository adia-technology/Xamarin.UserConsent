...
namespace Xamarin.UserConsent
{
    public class UserConsent
    {
        ...
        public async Task<ConsentFormResult> DisplayConsentRequest(DisplayConsentFormRequest request, PopupStyles popupStyles = null)
        {
            ...
            var popup = new UI.ConsentFormPage(ToConsentForm(request, popupStyles ?? PopupStyles.Default), resultHandler);
        ...
        private ConsentForm ToConsentForm(DisplayConsentFormRequest request, PopupStyles popupStyles)
            => new ConsentForm(
                request.Title,
                request.Rationale,
